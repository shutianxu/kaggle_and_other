# coding=utf-8
# @author:bryan
# based on github: https://github.com/YouChouNoBB/2018-tencent-ad-competition-baseline
...
def LGB_predict(train_x,train_y,test_x,res,index):
    ...
    clf = lgb.LGBMClassifier(
        boosting_type='gbdt', num_leaves=45, reg_alpha=0.0, reg_lambda=2,
        max_depth=20, n_estimators=1500, objective='binary',
        subsample=0.7, colsample_bytree=0.7, subsample_freq=3,
        learning_rate=0.5, min_child_weight=15, random_state=2018, n_jobs=-1
    )
